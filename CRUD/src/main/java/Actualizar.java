...
public class Actualizar {
	public void updateEstudiante(int id, String nombre, String apellido, String fechaNacimiento, String genero, String direccion, String telefono, String correo, String grado, String fechaInscripcion) {
